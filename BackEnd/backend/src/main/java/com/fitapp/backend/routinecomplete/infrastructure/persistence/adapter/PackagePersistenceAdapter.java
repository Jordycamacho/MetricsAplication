...
import com.fitapp.backend.routinecomplete.domain.model.PackageStatisticsModel;
...
import com.fitapp.backend.routinecomplete.infrastructure.persistence.repository.PackageItemRepository;
import com.fitapp.backend.routinecomplete.infrastructure.persistence.repository.PackageRepository;
...
public class PackagePersistenceAdapter implements PackagePersistencePort {
    ...
    public void delete(Long id) {
        ...
        //PackageEntity pkg = packageRepository.findById(id).orElseThrow(() -> new RuntimeException("Package not found: " + id));
