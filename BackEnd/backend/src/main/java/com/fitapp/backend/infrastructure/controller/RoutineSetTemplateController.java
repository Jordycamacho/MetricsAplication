...
import com.fitapp.backend.application.service.RoutineSetTemplateServiceImpl;
...
public class RoutineSetTemplateController {
    ...
    @Operation(summary = "Create set template", 
               description = "Creates a new set template for a routine exercise")
    @PostMapping
    ...
    @Operation(summary = "Update set template", 
               description = "Updates an existing set template")
    @PutMapping("/{id}")
    ...
    @Operation(summary = "Get set template by ID", 
               description = "Retrieves a specific set template by its ID")
    @GetMapping("/{id}")
    ...
    @Operation(summary = "Get set templates by routine exercise", 
               description = "Retrieves all set templates for a specific routine exercise")
    ...
    public ResponseEntity<List<RoutineSetTemplateResponse>> getSetTemplatesByRoutineExercise(
        ...
        var setTemplates = setTemplateService.getSetTemplatesByRoutineExercise(routineExerciseId, getEmailFromJwt(jwt));
    ...
    @Operation(summary = "Get set templates by group", 
               description = "Retrieves all set templates for a specific routine exercise and group")
    ...
    public ResponseEntity<List<RoutineSetTemplateResponse>> getSetTemplatesByGroup(
        ...
        var setTemplates = setTemplateService.getSetTemplatesByGroup(routineExerciseId, groupId, getEmailFromJwt(jwt));
        var responses = setTemplates.stream()
                .map(setTemplateMapper::toResponse)
                .collect(Collectors.toList());
    ...
    @Operation(summary = "Delete set template", 
               description = "Deletes a specific set template")
    @DeleteMapping("/{id}")
    ...
    @Operation(summary = "Delete set templates by routine exercise", 
               description = "Deletes all set templates for a specific routine exercise")
    ...
    @Operation(summary = "Reorder set templates", 
               description = "Reorders set templates for a specific routine exercise")
    ...
    public ResponseEntity<RoutineSetTemplateResponse> reorderSetTemplates(
        ...
        var reorderedSet = setTemplateService.reorderSetTemplates(routineExerciseId, setTemplateIds, getEmailFromJwt(jwt));
