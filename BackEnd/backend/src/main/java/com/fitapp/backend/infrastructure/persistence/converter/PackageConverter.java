...
import com.fitapp.backend.application.dto.package_.response.PackageItemResponse;
...
public class PackageConverter {
        ...
        public com.fitapp.backend.application.dto.package_.response.PackageDetailResponse.CreatorInfo toCreatorInfo(
                        CreatorModel creatorModel) {
                if (creatorModel == null)
                        return null;

                return com.fitapp.backend.application.dto.package_.response.PackageDetailResponse.CreatorInfo.builder()
        ...
        public com.fitapp.backend.application.dto.package_.response.PackageSummaryResponse toSummaryResponse(
                        PackageModel domain,
                        CreatorModel creator) {
                if (domain == null)
                        return null;

                return com.fitapp.backend.application.dto.package_.response.PackageSummaryResponse.builder()
                                .id(domain.getId())
                                .name(domain.getName())
        ...
        public com.fitapp.backend.application.dto.package_.response.PackageDetailResponse toDetailResponse(
                        PackageModel domain,
                        CreatorModel creator,
                ...
                List<com.fitapp.backend.application.dto.package_.response.PackageItemResponse> itemResponses = itemModels != null
                                ? itemModels.stream()
                ...
                return com.fitapp.backend.application.dto.package_.response.PackageDetailResponse.builder()
                                .id(domain.getId())
                                .name(domain.getName())
                                .description(domain.getDescription())
                                .slug(domain.getSlug())
        ...
        public com.fitapp.backend.application.dto.sport.response.SportResponse toSportResponse(SportEntity entity) {
                if (entity == null)
                        return null;

                com.fitapp.backend.application.dto.sport.response.SportResponse response = new com.fitapp.backend.application.dto.sport.response.SportResponse();
        ...
        public com.fitapp.backend.application.dto.exercise.response.ExerciseResponse toExerciseResponse(
                        ExerciseEntity entity) {
                if (entity == null)
                        return null;

                com.fitapp.backend.application.dto.exercise.response.ExerciseResponse response = new com.fitapp.backend.application.dto.exercise.response.ExerciseResponse();
                response.setId(entity.getId());
                response.setName(entity.getName());
                response.setDescription(entity.getDescription());
