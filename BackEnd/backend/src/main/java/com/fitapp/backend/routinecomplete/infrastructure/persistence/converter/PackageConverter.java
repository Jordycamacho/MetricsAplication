...
import com.fitapp.backend.routinecomplete.aplication.dto.package_.response.PackageItemResponse;
import com.fitapp.backend.routinecomplete.aplication.dto.routine.response.RoutineResponse;
import com.fitapp.backend.routinecomplete.domain.model.CreatorModel;
import com.fitapp.backend.routinecomplete.domain.model.PackageItemModel;
import com.fitapp.backend.routinecomplete.domain.model.PackageModel;
import com.fitapp.backend.routinecomplete.infrastructure.persistence.entity.PackageEntity;
import com.fitapp.backend.routinecomplete.infrastructure.persistence.entity.PackageItemEntity;
...
public class PackageConverter {
        ...
        public com.fitapp.backend.routinecomplete.aplication.dto.package_.response.PackageDetailResponse.CreatorInfo toCreatorInfo(
                        CreatorModel creatorModel) {
                if (creatorModel == null)
                        return null;

                return com.fitapp.backend.routinecomplete.aplication.dto.package_.response.PackageDetailResponse.CreatorInfo.builder()
        ...
        public com.fitapp.backend.routinecomplete.aplication.dto.package_.response.PackageSummaryResponse toSummaryResponse(
                        PackageModel domain,
                        CreatorModel creator) {
                if (domain == null)
                        return null;

                return com.fitapp.backend.routinecomplete.aplication.dto.package_.response.PackageSummaryResponse.builder()
                                .id(domain.getId())
                                .name(domain.getName())
        ...
        public com.fitapp.backend.routinecomplete.aplication.dto.package_.response.PackageDetailResponse toDetailResponse(
                        PackageModel domain,
                        CreatorModel creator,
                ...
                List<com.fitapp.backend.routinecomplete.aplication.dto.package_.response.PackageItemResponse> itemResponses = itemModels != null
                                ? itemModels.stream()
                ...
                return com.fitapp.backend.routinecomplete.aplication.dto.package_.response.PackageDetailResponse.builder()
                                .id(domain.getId())
                                .name(domain.getName())
                                .description(domain.getDescription())
                                .slug(domain.getSlug())
        ...
        public RoutineResponse toRoutineResponse(
