package com.fitapp.backend.routinecomplete.infrastructure.controller;

import com.fitapp.backend.infrastructure.shared.dto.PageResponse;
import com.fitapp.backend.routinecomplete.aplication.dto.package_.request.AddPackageItemRequest;
import com.fitapp.backend.routinecomplete.aplication.dto.package_.request.CreatePackageRequest;
import com.fitapp.backend.routinecomplete.aplication.dto.package_.request.PackageFilterRequest;
import com.fitapp.backend.routinecomplete.aplication.dto.package_.request.ReorderPackageItemsRequest;
import com.fitapp.backend.routinecomplete.aplication.dto.package_.request.UpdatePackageRequest;
import com.fitapp.backend.routinecomplete.aplication.dto.package_.response.PackageDetailResponse;
import com.fitapp.backend.routinecomplete.aplication.dto.package_.response.PackageItemResponse;
import com.fitapp.backend.routinecomplete.aplication.dto.package_.response.PackageStatisticsResponse;
import com.fitapp.backend.routinecomplete.aplication.dto.package_.response.PackageStatusChangeResponse;
import com.fitapp.backend.routinecomplete.aplication.dto.package_.response.PackageSummaryResponse;
import com.fitapp.backend.routinecomplete.aplication.port.input.PackageCommandUseCase;
import com.fitapp.backend.routinecomplete.aplication.port.input.PackageQueryUseCase;
