package com.fitapp.appfit.ui.subscription
...
import com.fitapp.appfit.model.SubscriptionViewModel
...
class SubscriptionFragment : Fragment() {
    ...
    private fun populateSubscription(sub: SubscriptionResponse) {
        ...
        // Mostrar botón cancelar solo si no es FREE
    ...
    private fun highlightCurrentPlan(currentType: String) {
        // Resaltar la tarjeta del plan activo
        ...
        // Badge "Actual" solo en el plan activo
        ...
        // Botones de upgrade: ocultar el del plan actual
