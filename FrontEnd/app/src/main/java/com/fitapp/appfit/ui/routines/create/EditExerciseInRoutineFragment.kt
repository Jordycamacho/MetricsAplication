...
class EditExerciseInRoutineFragment : Fragment() {
    ...
    /**
     * Muestra solo los chips de días que pertenecen a la rutina.
     * Los días llegan como string separado por comas desde Safe Args.
     */
    private fun setupDayChips() {
        ...
        // Si no hay días configurados en la rutina, mostrar todos
