...
object WorkoutSoundManager {
    ...
    fun init(context: Context) {
        ...
        try {
            ...
            initialized = true
            Timber.Forest.d("WorkoutSoundManager inicializado")
        } catch (e: Exception) {
            Timber.Forest.e(e, "Error inicializando WorkoutSoundManager")
        }
    }
    ...
    fun playRestFinished(context: Context) {
        ...
        try {
            ...
            Timber.Forest.e(e, "Error reproduciendo sonido")
        }
    }
    ...
    fun playSetComplete(context: Context) {
        ...
        try {
            ...
            Timber.Forest.e(e, "Error reproduciendo sonido set")
        }
    }
