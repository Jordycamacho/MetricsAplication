...
import com.fitapp.appfit.feature.exercise.data.ExerciseCategoryRepository
...
class ExerciseCategoryViewModel : ViewModel() {
    ...
    private val _availableCategoriesState =
        MutableLiveData<Resource<ExerciseCategoryPageResponse>?>()
    ...
    private val _categoriesForSpinnerState =
        MutableLiveData<Resource<List<ExerciseCategoryResponse>>>()
